...
button1 = tk.Button(text='McAfee f2023(Click To start)',command=connect, bg='brown',fg='white')
canvas1.create_window(150, 150, window=button1)

label1 = tk.Label(root, text= 'Loading,... App starts in few minutes🤩🤩🤩', fg='green', font=('helvetica', 9, 'bold'))
canvas1.create_window(150, 200, window=label1)
